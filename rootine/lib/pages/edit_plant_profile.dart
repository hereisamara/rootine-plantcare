...
class EditPlantProfile extends StatefulWidget {
  // static final String routeId = 'editPlantProfile';
  final String idToken;
  final PlantDetailsData plant;
  const EditPlantProfile(
      {super.key, required this.idToken, required this.plant});

  @override
  State<EditPlantProfile> createState() => _EditPlantProfileState();
}

class _EditPlantProfileState extends State<EditPlantProfile> {
  ...
  void initState() {
    ...
    _ageController = TextEditingController(text: widget.plant.plantDate);
    _noteController = TextEditingController(text: widget.plant.plantNote);
    locationValue = locations.contains(widget.plant.plantLocationType)
        ? widget.plant.plantLocationType
        : locations.first;
  }
  ...
  Future<void> getImage() async {
    ...
    if (pickedFile != null) {
      ...
      final tempPath = '${tempDir.path}/$plantId.jpg';
  ...
  Future<void> _deletePlantProfile() async {
    ApiService apiService = ApiService();
    try {
      await apiService.deletePlant(context, plantId);
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Plant deleted successfully')));
  ...
  Future<void> _editPlantProfile() async {
    ...
    ApiService apiService = ApiService();
    try {
      await apiService.editPlantProfile(
        context: context,
        idToken: widget.idToken,
        plantId: plantId,
        plantName: nameValue!,
        species: speciesValue ?? "Unknown",
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Plant profile updated successfully')));
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ImageUploader(
                imageDefaultPath: (widget.plant.imageUrl != null)
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    Color.fromARGB(255, 199, 85, 85),
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(8)),
                              ),
                              onPressed: _deletePlantProfile,
                              child: Text(
                                'Delete',
                                style: TextStyle(
                                    fontSize: 16,
